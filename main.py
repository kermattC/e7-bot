...
async def on_member_join(member):
  ...
  if rand_greeting == 0:
    ...
    await channel.send(f"Do you hear the approaching abyss {mention}? Just kidding! Welcome to the server and please change your nickname to your e7 name so we know who you are!")
